...
<nav class="navbar navbar-expand-lg bg-dark navbar-dark nav-tab">
        <div class="container-fluid">
            <h1 class="navbar-brand">Enter Your Credentials</h1>
            <ul class="navbar-nav">
                <li class="nav-item">
    ...
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            if (count($errors) > 0) {
                ...
                $imageFileName = ''; // Initialize the image file name
                if ($_FILES["image"]["error"] == 0) {
                    ...
                    if (in_array($imageExtension, $validImageExtension) && $fileSize <= 1000000) {
                        ...
                        move_uploaded_file($tmpName, 'images/' . $imageFileName);
                    }
                }
                ...
                if ($prepareStmt) {
                    mysqli_stmt_bind_param($stmt, "ssss", $fullName, $email, $passwordHash, $imageFileName);
